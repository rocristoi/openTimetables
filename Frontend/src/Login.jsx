...
return (
  <div className="h-screen w-screen flex items-center justify-center ">
    ...
    >
      <h1 className="text-gray-800 font-extrabold text-[32px] mb-2">
        Welcome Back!
      </h1>
      <p className="text-gray-600 font-medium text-[14px] text-center mb-8">
        Log in to manage your <span className="text-blue-500">timetables</span>
      </p>
      ...
      <a href="/register" className="text-gray-500 text-sm mb-4 hover:underline">
